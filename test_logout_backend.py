...
class TestLogoutBackend():
  ...
  def test_logout_backend(self):
    ...
    # 9 | click | css=.employee_name > .material-icons | 
    self.driver.find_element(By.CSS_SELECTOR, ".employee_name > .material-icons").click()
    # 10 | click | id=header_logout | 
    self.driver.find_element(By.ID, "header_logout").click()
    time.sleep(4)
